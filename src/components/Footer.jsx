...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1A1A1A] text-white !pt-12 !pb-5 w-full font-['Barlow']">
      <div className="max-w-[1065px] mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
        
        {/* Sol Bölüm: Logo ve İletişim */}
      ...
      {/* Alt Şerit */}
      <div className="border-t border-gray-800 max-w-[1065px] mx-auto pt-8 flex justify-between items-center px-4 !pt-5">
        <p className="text-xs text-gray-500">© 2023 Teknolojik Yemekler.</p>
        <div className="flex gap-4 ">
           {/* Twitter ikonu tasarındaki gibi sağa yaslı */}
          <TwitterIcon />
        </div>
      </div>
    </footer>
