    ...
    <main className="!bg-[#FAF7F2] !w-full !py-16 !font-['Barlow']">
      <div className="!max-w-[1065px] !mx-auto !px-4">
        ...
        <section className="!grid !grid-cols-1 md:!grid-cols-2 !gap-4 !mb-20">
          ...
          {/* Sol Büyük Kart: Yazılar üstte (justify-start) */}
          <div 
            className="!bg-[#CE2829] !bg-cover !bg-no-repeat !rounded-2xl !p-12 !h-[450px] !flex !flex-col !items-start !justify-start !text-white !relative !overflow-hidden !shadow-none"
            style={{ backgroundImage: "url('/images/iteration-2-images/cta/kart-1.png')" }}
          >
            <h2 className="!font-['Quattrocento'] !text-6xl !font-bold !leading-[1.1] !mb-4 !mt-4">Özel<br />Lezzetus</h2>
            <p className="!text-xl !font-medium !mb-8">Position:Absolute Acı Burger</p>
            <button className="!bg-white !text-[#CE2829] !px-10 !py-3 !rounded-full !font-bold !uppercase !text-xs !border-none !cursor-pointer hover:!bg-gray-100">
              SİPARİŞ VER
            </button>
          </div>
          
          <div className="!flex !flex-col !gap-4">
            {/* Sağ Üst Kart: İçerik dikeyde ortalı (justify-center) */}
            <div 
              className="!bg-[#292929] !bg-cover !bg-no-repeat !rounded-2xl !p-10 !flex-1 !flex !flex-col !items-start !justify-center !text-white"
            ...
            >
              ...
              <button className="!bg-white !text-[#CE2829] !px-8 !py-2.5 !rounded-full !font-bold !uppercase !text-[10px] !border-none !cursor-pointer">
                SİPARİŞ VER
              </button>
            </div>
            
            {/* Sağ Alt Kart: İçerik dikeyde ortalı */}
            <div 
              className="!bg-[#FDC913] !bg-cover !bg-no-repeat !rounded-2xl !p-10 !flex-1 !flex !flex-col !items-start !justify-center"
